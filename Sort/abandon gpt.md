# 算法学习第一步从放弃到入门，花了 42 天我终于走完了这一步
...
为什么简单调用一个排序方法，如sort，其性能会超过许多教科书上的算法呢？

答案其实很简单：这些书中的算法大多源于上世纪五六十年代，而你所调用的，则是经过无数工程师优化之后的现代算法。

计算机发展的时间太短了，让人很容易忽略它也是有历史的。

以数学为例，我们可以更容易理解这一点。古希腊哲学家芝诺对无穷悖论的探索，与牛顿和莱布尼茨对无穷问题的处理，显然不属于同一思考层面。
...
这次就让我们从排序算法的历史开始，探索学习算法的新方式。也许这次不仅能帮助你发掘学习算法的动力，还能促使你深入理解、灵活应用乃至于创新算法。
